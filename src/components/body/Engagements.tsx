...
export default function Engagements() {
  ...
  return (
    <section
      id="Engagements"
      className="relative w-full min-h-[500px] sm:min-h-[600px] lg:h-[700px] my-20 overflow-hidden shadow-2xl"
    >
      {/* --- Image de fond --- */}
      <motion.img
        src={couverture}
          ...
          <div className="space-y-4 ml-0 md:ml-20 mt-8 text-left">
            {engagements.map((text, index) => (
              ...
              >
                ...
                <p className="max-w-md text-gray-100 text-sm sm:text-base text-left">
                  {text}
                </p>
              </motion.div>
            ))}
